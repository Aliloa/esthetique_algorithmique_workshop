...
import { currentCharacter, setCurrentCharacter } from './state.js';
...
const scroll = document.querySelector(".story");
...
function showChoices(choices) {
    ...
    choices.forEach(choice => {
        ...
        if (choice.cost && coin < choice.cost) {
            btn.disabled = true;
            btn.textContent = `> ${choice.text} (pas assez de pièces)`;
...
function showScene(index) {
    ...
    if (scene.character) {
        setCurrentCharacter(scene.character);
